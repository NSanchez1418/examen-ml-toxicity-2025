...
execute:
  ...
  cache: false
  freeze: false
  eval: false    # <- NO ejecutar celdas en este .qmd
 
format:
  html:
    fig-format: png
    df-print: paged
    embed-resources: false   # <-- solo en este .qmd
---
...
# --- 1) Logistic Regression (texto + meta) ---
...
disp_lr = ConfusionMatrixDisplay.from_predictions(y_test, y_pred_lr)
disp_lr.plot()
plt.tight_layout()

# muestra en el preview (como en 'Incidentes')

plt.show()

# y también guarda para GitHub Pages

plt.savefig("docs/confmat_lr.png", dpi=150, bbox_inches="tight")

# --- 2) Naive Bayes SOLO TEXTO (baseline) ---
...
disp_nb = ConfusionMatrixDisplay.from_predictions(y_test, y_pred_nb)
disp_nb.plot()
plt.tight_layout()
plt.show()
plt.savefig("docs/confmat_nb.png", dpi=150, bbox_inches="tight")

```


### Matrices de confusión
![](confmat_lr.png){width=60%}
![](confmat_nb.png){width=60%}
